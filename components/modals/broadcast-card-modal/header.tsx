...
export function BroadcastHeader({ data, refetchCard, refetchLists, refetchAuditLogs }: HeaderProps) {
  ...
  const { mutate } = trpc.card.updateBroadcastCard.useMutation({
    onSuccess: ({ card }) => {
...
BroadcastHeader.Skeleton = function HeaderSkeleton() {
  return (
