...
export const listRouter = router({
  ...
  getBroadcastLists: publicProcedure.input(z.object({ boardId: z.string() })).query(async ({ input }) => {
    const orgId='b_123'
  ...
  createList: publicProcedure
    ...
    createBroadcastList: publicProcedure
    .input(
      z.object({
        boardId: z.string(),
        title: z.string().min(3, { message: 'Minimum 3 chars required.' }),
  ...
  updateList: publicProcedure
    ...
    updateBroadcastList: publicProcedure
    .input(
      z.object({
        boardId: z.string(),
        id: z.string(),
  ...
  deleteList: publicProcedure
    ...
    deleteBroadcastList: publicProcedure
    .input(
      z.object({
        id: z.string(),
        boardId: z.string(),
  ...
  copyList: publicProcedure
    ...
    copyBroadcastList: publicProcedure
    .input(
      z.object({
        id: z.string(),
        boardId: z.string(),
