...
export const boardRouter = router({
  ...
  createBroadcastBoard: publicProcedure.input(CreateBoardValidator).mutation(async ({ input }) => {
    const orgId='b_123'
  ...
  updateBoard: publicProcedure
    ...
    updateBroadcastBoard: publicProcedure
    .input(
      z.object({
        id: z.string(),
        title: z.string().min(3, { message: 'Title is too short.' }),
  ...
  deleteBroadcastBoard: publicProcedure.input(z.object({ id: z.string() })).mutation(async ({ input }) => {
    const orgId='b_123'
