...
export const cardRouter = router({
  getCard: publicProcedure
    ...
    getBroadcastCard: publicProcedure
    .input(
      z.object({
        id: z.string(),
      })
  ...
  createBroadcastCard: publicProcedure
    .input(
      z.object({
        title: z.string(),
        boardId: z.string(),
    ...
    updateBroadcastCard: publicProcedure
    .input(
      z.object({
        id: z.string(),
        listId: z.string(),  // Changed from boardId to listId
  ...
  deleteBroadcastCard: publicProcedure
  .input(z.object({ id: z.string(), listId: z.string() }))
  .mutation(async ({ input }) => {
    const orgId='b_123'
  ...
  updateCardOrder: publicProcedure
    ...
    copyBroadcastCard: publicProcedure
    .input(z.object({ id: z.string(), listId: z.string() }))
    .mutation(async ({ input }) => {
      const orgId='b_123'
      const { id, listId } = input
