...
import { BroadcastFormPopover } from '@/components/form/broadcast-form-popover'
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
        ...
        <BroadcastFormPopover side="right" sideOffset={10} orgId={orgId}>
          <div
            ...
            role="button"
          >
            <p className="text-sm text-center">Create new broadcast channel</p>
            <Hint
